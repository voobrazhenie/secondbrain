...
- **Preserve each page's write model.** Existing DailyPlan, XP, and config whole-snapshot writes
  stay unmerged except for DailyPlan's documented priority-only and clear-ticks partial writes.
